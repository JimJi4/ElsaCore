            ...
            builder
                ...
                .SendEmail(activity => activity
                    ...
                    //.WithSubject(context => $"Document received from {context.GetVariable<dynamic>("Document")!.Author.Name}")
                     .WithSubject(context => $"Document received from {JsonConvert.DeserializeObject<ExpandoObject>(context.GetVariable<dynamic>("Document"))!.Author.Name}")
                    .WithBody(context =>
                    {
                ...
                .Then<Fork>(activity => activity.WithBranches("Approve", "Reject", "Remind"), fork =>
                {
                    fork
                        ...
                        .SendEmail(activity => activity
                         ...
                         .WithRecipient(context => JsonConvert.DeserializeObject<ExpandoObject>(context.GetVariable<dynamic>("Document"))!.Author.Email)
                            .WithSubject(context => $"Document {JsonConvert.DeserializeObject<ExpandoObject>(context.GetVariable<dynamic>("Document"))!.Id} Approved!")
                            .WithBody(context => $"Great job {JsonConvert.DeserializeObject<ExpandoObject>(context.GetVariable<dynamic>("Document"))!.Author.Name}, that document is perfect."))
                        .ThenNamed("Join");
                    ...
                    fork
                        ...
                        .SendEmail(activity => activity
                         ...
                         .WithRecipient(context => JsonConvert.DeserializeObject<ExpandoObject>(context.GetVariable<dynamic>("Document"))!.Author.Email)
                            .WithSubject(context => $"Document {JsonConvert.DeserializeObject<ExpandoObject>(context.GetVariable<dynamic>("Document"))!.Id} Rejected")
                            .WithBody(context => $"Nice try {JsonConvert.DeserializeObject<ExpandoObject>(context.GetVariable<dynamic>("Document"))!.Author.Name}, but that document needs work."))
                        .ThenNamed("Join");
